...
function view(userState, quotes, login) {
  ...
  .startWith({ text: 'Loading...', screen: 'welcome' }).map(function (_ref) {
    ...
    return (0, _dom.div)('.page', [quotes.renderQuote(text, logged), (0, _dom.div)('.login-container', [login.renderLoginSection(screen, username), (0, _dom.span)('.error', error ? 'Error: ' + error : '')])]);
  });
}
...
function main(sources) {
  ...
  /* ACTIONS definitions */
  var quoteActions = quotes.quoteIntent(sources);
  var loginActions = login.loginIntent(sources);
